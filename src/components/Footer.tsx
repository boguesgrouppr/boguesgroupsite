...
const quickLinks = [
  ...
  { label: "Speaker Roster", href: "/speaker-roster" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              ...
              communications that elevate your brand and amplify your story.
            </p>
            <div className="flex gap-4">
              <a
                href="https://www.linkedin.com/company/bogues-consulting-group/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/boguesgroup/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/40 hover:text-gold transition-colors"
              ...
              <a
                href="https://www.facebook.com/BoguesGroup/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/40 hover:text-gold transition-colors"
                aria-label="Facebook"
